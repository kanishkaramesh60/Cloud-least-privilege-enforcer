...
def get_action(event):
    ...
    # Extract the AWS service directly
    # from eventSource.
    #
    # Example:
...
def main():
    ...
    print("=" * 60)
    print(
        "       CLOUDTRAIL IAM ACTION EXTRACTION"
    )
    print("=" * 60)
    ...
    if not isinstance(
        ...
        print(
            "ERROR: Expected CloudTrail data to be a list."
        )
    ...
    report = {
        ...
        "description":
            "Extracts IAM-style actions from CloudTrail event_source and event_name.",
    ...
    print(
        "IAM ACTION EXTRACTION COMPLETED"
    )
